...
async def start():
    ...
    try:
        ...
        with open('appgenpro_chat_config.json', 'r') as file:
    ...
    try:
        ...
        msg = f"Application is generated, and pushed to {github_url} successfully! Thank you for using AppGenPro! Final estimated cost: ${CONFIG.total_cost:.2f}"
        logger.debug(msg)
        logger.info(msg)
